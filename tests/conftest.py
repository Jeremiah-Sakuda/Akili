...
def sample_units() -> list[Unit]:
    ...
    return [
        ...
        Unit(
            ...
            value=250,
            unit_of_measure="mA",
            context="maximum supply current",
        ...
        Unit(
            ...
            value=2000,
            unit_of_measure="V",
            context="ESD Human Body Model",
            origin=Point(x=0.5, y=0.1),
            doc_id="d1",
            page=0,
        ),
        Unit(
            ...
            value=500,
            unit_of_measure="V",
            context="ESD Charged Device Model",
            origin=Point(x=0.5, y=0.15),
            doc_id="d1",
            page=0,
        ),
        Unit(
            ...
            value=1,
            unit_of_measure="µA",
            context="input leakage current",
            origin=Point(x=0.6, y=0.1),
            doc_id="d1",
            page=0,
        ),
        Unit(
            ...
            value=0.8,
            unit_of_measure="V",
            context="input low threshold voltage",
            origin=Point(x=0.7, y=0.1),
            doc_id="d1",
            page=0,
        ),
        Unit(
            ...
            value=2.0,
            unit_of_measure="V",
            context="input high threshold voltage",
            origin=Point(x=0.7, y=0.15),
            doc_id="d1",
            page=0,
        ),
        Unit(
            ...
            value=100,
            unit_of_measure="MHz",
            context="maximum clock frequency",
        ...
        Unit(
            ...
            value=5.5,
            unit_of_measure="ns",
            context="propagation delay",
            origin=Point(x=0.2, y=0.2),
            doc_id="d1",
            page=1,
        ),
        Unit(
        ...
        Unit(
            ...
            value=7.0,
            unit_of_measure="mm",
            context="package dimension length",
        ...
        Unit(
            ...
            value=7.0,
            unit_of_measure="mm",
            context="package dimension width",
        ...
        Unit(
            ...
            value="3",
            unit_of_measure=None,
            context="moisture sensitivity level",
            origin=Point(x=0.6, y=0.3),
            doc_id="d1",
            page=2,
        ),
        Unit(
            ...
            value=-40,
            unit_of_measure="°C",
            context="operating temperature minimum",
            origin=Point(x=0.1, y=0.4),
            doc_id="d1",
            page=0,
        ),
        Unit(
            ...
            value=85,
            unit_of_measure="°C",
            context="operating temperature maximum",
        ...
        Unit(
            ...
            value=-65,
            unit_of_measure="°C",
            context="storage temperature minimum",
        ...
        Unit(
            ...
            value=150,
            unit_of_measure="°C",
            context="storage temperature maximum",
            origin=Point(x=0.4, y=0.4),
            doc_id="d1",
            page=0,
        ),
        Unit(
            ...
            value=260,
            unit_of_measure="°C",
            context="reflow soldering temperature",
        ...
        Unit(
            id="u_absmax_i",
            label="Absolute max current",
            value=500,
            unit_of_measure="mA",
            context="absolute maximum current",
            origin=Point(x=0.6, y=0.4),
            doc_id="d1",
            page=0,
        ),
        Unit(
        ...
        Unit(
            id="u_desc",
            label="Description",
            value="High-speed 48-pin quad flat package logic IC",
            unit_of_measure=None,
            context="general description overview",
            origin=Point(x=0.2, y=0.5),
            doc_id="d1",
            page=0,
        ),
        Unit(
            ...
            value=2.7,
            unit_of_measure="V",
            context="minimum supply voltage",
            origin=Point(x=0.1, y=0.05),
            doc_id="d1",
            page=0,
        ),
    ]
        ...
        Grid(
            ...
            cells=[
                ...
                GridCell(
                    row=3,
                    col=0,
                    value="Recommended Operating Conditions",
                    origin=Point(x=0.1, y=0.65),
                ),
